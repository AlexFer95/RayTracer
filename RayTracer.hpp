...
Material p_azul = { azul, 0.0 , 0.0 , 70.0, Phong};
Material p_azul2 = { azul, 0.001 , 0.0 , 70.0, Phong};
Material p_azul3 = { azul, 0.01 , 0.0 , 70.0, Phong};
Material p_azul4 = { azul, 0.1 , 0.0 , 70.0, Phong};
Material p_azul5 = { azul, 0.3 , 0.0 , 70.0, Phong};
Material p_amar = { amarillo , 0.0 , 0.0 , 70.0, Phong};
Material p_amar2 = { amarillo , 0.001 , 0.0 , 70.0, Phong};
Material p_amar3 = { amarillo , 0.01 , 0.0 , 70.0, Phong};
Material p_amar4 = { amarillo , 0.1 , 0.0 , 70.0, Phong};
Material p_amar5 = { amarillo , 0.3 , 0.0 , 70.0, Phong};
Material p_mora = { morado , 0.0 , 0.0 , 70.0, Phong};
Material p_mora2 = { morado , 0.1 , 0.0 , 70.0, Phong};
Material p_rojo = { rojo , 0.0 , 0.0 , 70.0, Phong};
Material p_rojo2 = { rojo , 0.001 , 0.0 , 70.0, Phong};
Material p_rojo3 = { rojo , 0.01, 0.0 , 70.0, Phong};
Material p_rojo4 = { rojo , 0.1 , 0.0 , 70.0, Phong};
Material p_rojo5 = { rojo , 0.3 , 0.0 , 70.0, Phong};
Material p_verde = { verde , 0.0 , 0.0 , 70.0, Phong};
Material p_verde2 = { verde , 0.001 , 0.0 , 70.0, Phong};
Material p_verde3 = { verde , 0.01 , 0.0 , 70.0, Phong};
Material p_verde4 = { verde , 0.1 , 0.0 , 70.0, Phong};
Material p_verde5 = { verde , 0.3 , 0.0 , 70.0, Phong};
Material p_marron = { marron , 0.0 , 0.0 , 70.0, Phong};
