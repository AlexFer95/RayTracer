...
FuenteLuz f0(Punto(camara.getPref()->getX()+DISTANCIA_PANTALLA*10, camara.getPref()->getY()+DISTANCIA_PANTALLA*2, DISTANCIA_PANTALLA*8), 1500);
FuenteLuz f1(Punto(camara.getPref()->getX()-DISTANCIA_PANTALLA*10, camara.getPref()->getY()+DISTANCIA_PANTALLA*2, DISTANCIA_PANTALLA*8), 1500);
int num_luces = 2;
FuenteLuz *lista_luces[] = {&f0,&f1};
//Definir objetos de la escena
Esfera suelo(Punto(camara.getPref()->getX(), camara.getPref()->getY()-DISTANCIA_PANTALLA*404, DISTANCIA_PANTALLA*12), DISTANCIA_PANTALLA*400, 0.3, 1, 1, 0);
Esfera fondo(Punto(camara.getPref()->getX(), camara.getPref()->getY(), DISTANCIA_PANTALLA*416), DISTANCIA_PANTALLA*400, 1, 1, 0.3, 0);
Esfera e0(Punto(camara.getPref()->getX()+DISTANCIA_PANTALLA*4, camara.getPref()->getY()-DISTANCIA_PANTALLA*1.5, DISTANCIA_PANTALLA*12), DISTANCIA_PANTALLA/2, 1, 0.1, 0.1, 0.1);
Esfera e1(Punto(camara.getPref()->getX()+DISTANCIA_PANTALLA, camara.getPref()->getY()-DISTANCIA_PANTALLA, DISTANCIA_PANTALLA*12), DISTANCIA_PANTALLA, 0.1, 1, 0.1, 0.5, Reflexion);
Esfera e2(Punto(camara.getPref()->getX()+DISTANCIA_PANTALLA*-4, camara.getPref()->getY(), DISTANCIA_PANTALLA*12), DISTANCIA_PANTALLA*2, 0.1, 0.1, 1, 0.9);
int num_esferas = 5;
Esfera *lista_esferas[] = {&suelo,&fondo,&e0,&e1,&e2};
